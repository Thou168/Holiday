package com.example.holiday.Buy_sell_rent.Sell.Adapter;
...
public class Computer extends RecyclerView.Adapter<Computer.ViewHolder> {

    private LayoutInflater layoutInflater;
    private Context context;
    private ArrayList<Item_Post> items;

    public Computer(Context context, ArrayList<Item_Post> items) {
      ...
      //  view.time.setText(item.getTime());
        ...
        view.linearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, Detail_phone.class);
