...
public class Electronic extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
...
//        banners.add(new RemoteBanner("https://assets.materialup.com/uploads/20ded50d-cc85-4e72-9ce3-452671cf7a6d/preview.jpg"));
        ...
        Adapter_for_buy adapter1 = new Adapter_for_buy(getBaseContext(),item_phone);
